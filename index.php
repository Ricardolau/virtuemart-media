		...
		<div class="container">
			<div class="col-md-8">
				...
				<h3>Preguntas Frecuentes</h3>
					<div>
					<h4>Nuestra seccion de Recorte Imagenes</h4>
							<h5>
								<?php 
					...
					<div>
					<h4>Nuestra Seccion Revisar Imagenes Productos</h4>
						<h5>
							<?php 
							/* Para que este expandido, lo hace con date aria-expanded ="false" o "true"
							 * */
							?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="false">Que hace "Revisar Imagenes productos"?
							<span style="float:right;" class="icono-collapse">+</span>
							</a>
						...
						<div id="collapse2" class="collapse pepe">
							<p>Analiza:</p>
							<ul>
							<li>  Las imagenes que tenemos asignadas a los productos, si existen y tiene una extension correcta ( solo permito jpg y png).</li>
							<li>  Mostramos la cantidad imagenes que tiene un producto asignadas</li>
							<li>  Las imagenes que tenemos en la carpeta asignada para productos son correctas y cuales no.</li>
							<li>  Que imagenes tenemos en la carpeta asignada y no utilizamos en ningún producto.</li>
					...
					<div>
					<h4>Virtuemart: Gestion de Medios</h4>
							<h5>
								<?php 
								/* Para que este expandido, lo hace con date aria-expanded ="false" o "true"
								 * */
								?>
								<a data-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-expanded="false">Si eliminamos una imagen directamente en el servidor de un producto ¿ que sucede?
								<span style="float:right;" class="icono-collapse">+</span>
								</a>
							...
							<h5>
								 ...
								 * */
								?>
								<a data-toggle="collapse" data-parent="#accordion" href="#collapse4" aria-expanded="false">Si eliminamos una imagen en virtuemart en productos ( pestaña imagenes ) ¿ que sucede?
								<span style="float:right;" class="icono-collapse">+</span>
								</a>
								
							</h5>
							<div id="collapse4" class="collapse pepe">
							...
							<h5>
								 ...
								 * */
								?>
								<a data-toggle="collapse" data-parent="#accordion" href="#collapse5" aria-expanded="false">¿Que hace realmente el gestor multimedia de virtuemart?
								<span style="float:right;" class="icono-collapse">+</span>
								</a>
								
							</h5>
							<div id="collapse5" class="collapse pepe">
								...
								<p>Aquí puedes ver <a href="http://ayuda.svigo.es/index.php/programacion-2/cms/joomla/componentes/virtuemart/144-archivo-de-medios-de-virtuemart">mas info</a></p>
